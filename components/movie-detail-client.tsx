...
import { ArrowLeft, Clock, Star, Bookmark, Play, Calendar, UserRound } from "lucide-react"
    ...
    <>
      ...
      <div className="mx-auto max-w-6xl px-4">
          ...
          <div className="grid grid-cols-1 gap-8 md:grid-cols-[260px_1fr]">
            ...
            <div className="flex flex-col gap-5 pt-2">
              <div>
                ...
                <p className="mt-1 text-lg text-muted-foreground">{movie.titleMn}</p>
              </div>
              ...
              <div className="flex flex-wrap items-center gap-3">
                <div className="flex items-center gap-1.5 rounded-lg bg-accent/10 px-3 py-1.5">
                  ...
                  <span className="text-sm font-semibold text-accent">{movie.rating}/5</span>
                </div>
                <div className="flex items-center gap-1.5 rounded-lg bg-secondary px-3 py-1.5">
                  <span className="text-xs font-medium text-muted-foreground">IMDb</span>
                  <span className="text-sm font-semibold text-foreground">{movie.imdb}</span>
                </div>
                <div className="flex items-center gap-1.5 rounded-lg bg-secondary px-3 py-1.5">
                  <Clock className="h-3.5 w-3.5 text-muted-foreground" />
                  <span className="text-sm text-foreground">{movie.duration}</span>
                </div>
                <div className="flex items-center gap-1.5 rounded-lg bg-secondary px-3 py-1.5">
              ...
              <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="text-xs font-medium text-muted-foreground">Найруулагч</p>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="text-xs font-medium text-muted-foreground">Жүжигчид</p>
                    <p className="text-sm font-medium text-foreground">{movie.cast.join(", ")}</p>
                  </div>
                </div>
              </div>
        ...
        <section className="mt-14 pb-4">
          <h2 className="mb-4 text-lg font-semibold text-foreground">Трейлэр</h2>
