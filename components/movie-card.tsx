    ...
    >
      <div className="relative aspect-[2/3] overflow-hidden bg-muted">
        ...
        <div className="absolute left-2 top-2 flex items-center gap-1 rounded-md bg-card/90 px-1.5 py-0.5 backdrop-blur-sm">
          ...
          <span className="text-[11px] font-semibold text-foreground">{movie.rating}</span>
        </div>
      </div>
      <div className="flex flex-1 flex-col gap-1 p-3">
        ...
        <p className="line-clamp-1 text-xs text-muted-foreground">{movie.titleMn}</p>
        <div className="mt-auto flex items-center gap-1.5 pt-1.5">
          ...
          <span className="ml-auto text-[11px] text-muted-foreground">{movie.year}</span>
        </div>
      </div>
    </Link>
  )
