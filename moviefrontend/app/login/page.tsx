    ...
    <div className="flex min-h-[calc(100vh-8rem)] items-center justify-center px-4">
      <div className="w-full max-w-sm">
        <div className="mb-8 text-center">
          ...
          <p className="mt-1 text-sm text-muted-foreground">MovieRate.mn-д тавтай морил</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          ...
          <Button type="submit" disabled={loading} className="mt-2 w-full gap-2 bg-primary text-primary-foreground hover:bg-primary/90">
        ...
        <p className="mt-6 text-center text-sm text-muted-foreground">
          Бүртгэл байхгүй юу? <Link href="/register" className="font-medium text-accent hover:underline">Бүртгүүлэх</Link>
        </p>
      </div>
    </div>
  );
